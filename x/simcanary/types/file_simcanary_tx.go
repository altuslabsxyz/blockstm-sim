...
func buildFileDescriptor() []byte {
	...
	fd := &descriptorpb.FileDescriptorProto{
		...
		MessageType: []*descriptorpb.DescriptorProto{
			...
			msgDescriptorWithOpts("MsgCanaryBlockContextSet", signerOpts,
				fieldString(1, "sender"),
				fieldString(2, "field"),
				fieldString(3, "value"),
			),
			msgDescriptor("MsgCanaryBlockContextSetResponse"),
			msgDescriptorWithOpts("MsgCanaryBlockContextRead", signerOpts,
				fieldString(1, "sender"),
				fieldString(2, "field"),
			),
			msgDescriptor("MsgCanaryBlockContextReadResponse",
				fieldString(1, "value"),
			),
		},
		Service: []*descriptorpb.ServiceDescriptorProto{{
			...
			Method: []*descriptorpb.MethodDescriptorProto{
				...
				{
					Name:       strPtr("BlockContextSet"),
					InputType:  strPtr(".simcanary.v1.MsgCanaryBlockContextSet"),
					OutputType: strPtr(".simcanary.v1.MsgCanaryBlockContextSetResponse"),
				},
				{
					Name:       strPtr("BlockContextRead"),
					InputType:  strPtr(".simcanary.v1.MsgCanaryBlockContextRead"),
					OutputType: strPtr(".simcanary.v1.MsgCanaryBlockContextReadResponse"),
				},
			},
		}},
	}
