...
type Params struct {
	...
	Erc20GasToken      *ERC20GasToken `protobuf:"bytes,1000,opt,name=erc20_gas_token,json=erc20GasToken,proto3" json:"erc20_gas_token,omitempty"`
}
...
func (m *Params) GetErc20GasToken() *ERC20GasToken {
	if m != nil {
		return m.Erc20GasToken
	}
	return nil
}
...
// ERC20GasToken is a token that is used to pay for gas on the ERC20 chain.
type ERC20GasToken struct {
	Denom                string `protobuf:"bytes,1,opt,name=denom,proto3" json:"denom,omitempty"`
...
func (m *ERC20GasToken) Reset()         { *m = ERC20GasToken{} }
func (m *ERC20GasToken) String() string { return proto.CompactTextString(m) }
func (*ERC20GasToken) ProtoMessage()    {}
func (*ERC20GasToken) Descriptor() ([]byte, []int) {
	return fileDescriptor_dd052eee12edf988, []int{2}
}
func (m *ERC20GasToken) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ERC20GasToken) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ERC20GasToken.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ERC20GasToken) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ERC20GasToken.Merge(m, src)
}
func (m *ERC20GasToken) XXX_Size() int {
	return m.Size()
}
func (m *ERC20GasToken) XXX_DiscardUnknown() {
	xxx_messageInfo_ERC20GasToken.DiscardUnknown(m)
}

var xxx_messageInfo_ERC20GasToken proto.InternalMessageInfo

func (m *ERC20GasToken) GetDenom() string {
	if m != nil {
		return m.Denom
	}
	return ""
...
func (m *ERC20GasToken) GetErc20ContractAddress() string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*ERC20GasToken)(nil), "cosmos.bank.v1beta1.ERC20GasToken")
...
var fileDescriptor_dd052eee12edf988 = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.Erc20GasToken != nil {
		{
			size, err := m.Erc20GasToken.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ERC20GasToken) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ERC20GasToken) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ERC20GasToken) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Erc20ContractAddress) > 0 {
		...
		i = encodeVarintBank(dAtA, i, uint64(len(m.Erc20ContractAddress)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Denom) > 0 {
...
func (m *Params) Size() (n int) {
	...
	if m.Erc20GasToken != nil {
		l = m.Erc20GasToken.Size()
		n += 2 + l + sovBank(uint64(l))
	}
	return n
}
...
func (m *ERC20GasToken) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1000:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Erc20GasToken", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.Erc20GasToken == nil {
				m.Erc20GasToken = &ERC20GasToken{}
			}
			if err := m.Erc20GasToken.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ERC20GasToken) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ERC20GasToken: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ERC20GasToken: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
