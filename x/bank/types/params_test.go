...
func Test_validateParams(t *testing.T) {
	...
	assert.Error(t, Params{[]*SendEnabled{{"foocoing", false}}, true, nil}.Validate(), "with SendEnabled entry")
}
